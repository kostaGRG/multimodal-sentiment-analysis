...
Η ιστοσελίδα δέχεται κείμενα και στα ελληνικά και στα αγγλικά, ενώ μπορεί να διαχειριστεί και είσοδο μόνο ενός τύπου δεδομένων, δηλαδή μπορεί να δοθεί μόνο κείμενο ή μόνο εικόνα. 
